...
plot(d1J4, d1J4x) # bounaries values for efficacy are relaxed when futility stopping was used 

(d1J4.eval = seqEvaluate(d1J4))
plot(d1J2, d1J4)

# What exact are the different bounary shape parameters (the unified family of group sequential stopping rules)
